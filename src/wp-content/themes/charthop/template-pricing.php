                            ...
                            <div class="col-auto">
                                ...
                                <div class="table_note table_note--table">
                                    ...
                                    <h4>'.$featt->name.'</h4>';
                                        ...
                                        if ($featt->description)
                                        {
                                            $feature_mobile_htmls[$featt->term_id] .= '<p>'.$featt->description.'</p>';
                                        }

                                        $link = get_field('fts_cta_button', 'features_' . $featt->term_id);
                                        if ($link)
                                        {
                                            if ($link['target'])
                                            {
                                                $feature_mobile_htmls[$featt->term_id] .= '<a href="'.$link['url'].'" target="_blank" class="readmore white">'.$link['title'].'</a>';
                                            }
                                            else
                                            {
                                                $feature_mobile_htmls[$featt->term_id] .= '<a href="'.$link['url'].'" class="readmore white">'.$link['title'].'</a>';
                                            }
                                        }
                                        $feature_mobile_htmls[$featt->term_id] .= '
                                </div>
    ...
    ?><section class="trusted_by pricing">
        <div class="container"><?php
            ...
            ?><div class="row align-items-center"><?php
                ...
                if (get_field('psc_use_global'))
                {
                    while (have_rows('logos_trusted', 'options')) : the_row();

                        $image = get_sub_field('image');
                        echo '<div class="col-6 col-sm-4 col-lg-3 col-xl-2"><span class="proud_part_box">';
                        echo '<img src="'.$image.'" alt="" data-no-retina></span></div>';
