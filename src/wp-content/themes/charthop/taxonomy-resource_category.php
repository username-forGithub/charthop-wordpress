...
if (strpos($_SERVER['REQUEST_URI'], 'resources/all/') === false)
{
    global $wp_query;
    $wp_query->set_404();
    status_header( 404 );
...
$cat = get_term_by('term_id', $cat_id, 'resource_category');
$acf_key = 'resource_category_' . $cat_id;

$template = get_field('rco_template', $acf_key);
...
get_header();
$hide_section_1 = get_field('rco_shos', $acf_key);
$hide_section_2 = get_field('rco_shss', $acf_key);
$template = get_field('rco_template', $acf_key);
$extra_class = [];
...
{
    $extra_class[] = 'resources';
}

$content_types = get_terms('content_type', ['hide_empty' => false]);
$content_links = [];

$categories = get_terms('resource_category', ['hide_empty' => true]);
$category_links = [];
                    ...
                    <select id="categories">
                        ...
                        if (is_array($categories)) :
                            ...
                            foreach ($categories as $category)  :
                                ...
                                if ($category->term_id == $cat_id) continue;
...
if (! empty($resources)) :
    ...
    <div class="container ">
        <div class="row latest_blog_row filter_results grid52"><?php
            ...
            {
                echo '<div class="col-12 blog_pages '.$extra_class2.' resource_pagination d-none" data-count="'.$posts_per_page.'" data-cat="'.$cat_id.'" data-page="'.$cur_page.'" data-total="'.$total_page.'">';
            }
            else
            {
                echo '<div class="col-12 blog_pages '.$extra_class2.' resource_pagination" data-count="'.$posts_per_page.'" data-cat="'.$cat_id.'" data-page="'.$cur_page.'" data-total="'.$total_page.'">';
            }
