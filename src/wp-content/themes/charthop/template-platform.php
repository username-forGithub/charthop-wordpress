<?php /*Template name: Platform Template */ ?>
<?php get_header();?>
                ...
                <ul>
                    ...
                    ?>   
                                <?php if($count_title == 1){ ;?>
                                    <li>
                                        <a class="nav-link active" href="#id<?php echo $count_title; ?>"><?php echo get_sub_field('title'); ?> </a>
                                    </li>
                                <?php } else { ;?>
                                    <li>
                                        <a class="nav-link " href="#id<?php echo $count_title; ?>"><?php echo get_sub_field('title'); ?> </a>
                                    </li>
                                <?php } ;?>
                        <?php $count_title++; ?>
                    <?php endwhile; else : endif; ?>
