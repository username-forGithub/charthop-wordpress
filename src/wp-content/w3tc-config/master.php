<?php exit; ?>{
    ...
    "minify.csstidy.options.lowercase_s": true,
    "minify.csstidy.options.optimise_shorthands": 0,
    "minify.csstidy.options.remove_last_;": true,
    "minify.csstidy.options.remove_space_before_important": true,
